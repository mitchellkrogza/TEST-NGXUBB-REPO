...
curl -A "80legs" http://nginxbadbotblocker.com/index.php 2> $_curltest1
...
curl -A "masscan" http://nginxbadbotblocker.com/index.php 2> $_curltest2
...
curl -I http://nginxbadbotblocker.com/index.php -e http://100dollars-seo.com 2> $_curltest3
...
curl -I http://nginxbadbotblocker.com/index.php -e http://zx6.ru 2> $_curltest4
...
curl -v -A "GoogleBot" http://nginxbadbotblocker.com/index.php 2>&1 >> $_curltest5
...
curl -v -A "BingBot" http://nginxbadbotblocker.com/index.php 2>&1 >> $_curltest6
