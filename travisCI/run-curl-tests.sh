...
curl -A "80legs" http://localhost:80/index.php 2> $_curltest1
...
curl -A "masscan" http://localhost:80/index.php 2> $_curltest2
...
curl -I http://localhost:80/index.php -e http://100dollars-seo.com 2> $_curltest3
...
curl -I http://localhost:80/index.php -e http://zx6.ru 2> $_curltest4
...
curl -v -A "GoogleBot" http://localhost:80/index.php 2>&1 >> $_curltest5
...
curl -v -A "BingBot" http://localhost:80/index.php 2>&1 >> $_curltest6
